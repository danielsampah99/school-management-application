...
export const createOneCoures = async (req: Request, res: Response) => {
...
export const updateOneCourse = async (req: Request, res: Response) => {
	const { id } = req.params;
...
export const deleteOneCourse = async (req: Request, res: Response) => {
	try {
		const { id } = req.params;
